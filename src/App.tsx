...
function App() {
  ...
  useEffect(() => {
    ...
    // When reduced motion is enabled, disable smooth scrolling entirely.
    if (reduceMotion) {
      if (lenisRef.current) {
    ...
    <MotionConfig reducedMotion={reduceMotion ? 'always' : 'never'}>
      <div className="min-h-screen bg-bg-dark relative overflow-x-hidden font-sans text-text-primary flex flex-col">
        ...
        <div className="fixed inset-0 pointer-events-none z-0">
          ...
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-accent-cyan/8 rounded-full blur-[140px] animate-aurora" />
          <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-accent-purple/8 rounded-full blur-[140px] animate-aurora-delay-2" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-accent-blue/5 rounded-full blur-[160px] animate-aurora-delay-4" />
          {/* Subtle vignette overlay */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_40%,rgba(6,9,20,0.5)_100%)]" />
        </div>
