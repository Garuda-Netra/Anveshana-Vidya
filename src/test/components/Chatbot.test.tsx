...
describe('Chatbot Component', () => {
  ...
  it('displays contextual suggestions', () => {
    ...
    expect(screen.getByText('Show me ransomware-investigation artifacts')).toBeInTheDocument();
  });
  ...
  it('handles tool queries with knowledge service', async () => {
    ...
    await waitFor(() => {
      // This exact sentence distinguishes the response from the initial message (which ends with a colon).
