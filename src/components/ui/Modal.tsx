    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          exit={{ opacity: 0 }}
          onClick={onClose}
          className="absolute inset-0 bg-[rgba(6,9,20,0.8)] backdrop-blur-[12px]"
        ...
        >
          <GlassPanel className="flex flex-col max-h-full shadow-2xl border-accent-neon/30 bg-[rgba(10,14,26,0.92)] backdrop-blur-xl overflow-hidden">
            {/* Modal Header */}
            <div className="flex-shrink-0 flex items-center justify-between px-6 py-4 border-b border-border-glass bg-bg-darker/80">
              <h3 
                id="modal-title"
            ...
            <div 
              className="custom-scroll flex-1 px-8 py-6 bg-[rgba(6,9,20,0.5)] overflow-y-auto"
              data-lenis-prevent
              style={{
                maxHeight: '100%',
                overscrollBehavior: 'contain',
